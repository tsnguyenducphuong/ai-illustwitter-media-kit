...
/**
 * A Kotlin class representing the AIMediaKit HybridObject.
 * Implement this abstract class to create Kotlin-based instances of AIMediaKit.
 */
@DoNotStrip
@Keep
@Suppress(
...
abstract class HybridAIMediaKitSpec: HybridObject() {
  @DoNotStrip
  ...
  companion object {
    private const val TAG = "HybridAIMediaKitSpec"
  }
}
